...
import { Users, Package, ActivityIcon as Assignment, Grid3X3, LogOut, BarChart3 } from "lucide-react"
...
const Sidebar = ({ activeTab, setActiveTab }) => {
  ...
  return (
    <div className="bg-blue-900 text-white w-64 min-h-screen flex flex-col shadow-lg">
      {/* Logo Section */}
      <div className="p-6 border-b border-blue-800 dark:border-blue-700">
        <div className="flex items-center space-x-3">
          ...
          <div>
            <h1 className="text-xl font-bold">¡HUZA</h1>
            <p className="text-blue-200 text-sm font-medium">INVENTORY</p>
          </div>
        </div>
      </div>
      ...
      <div className="p-4 border-t border-blue-800 dark:border-blue-700">
        <div className="flex items-center space-x-3 mb-4">
          <div className="w-10 h-10 bg-blue-600 rounded-full flex items-center justify-center">
            <span className="text-sm font-bold">{loginUser?.username?.charAt(0) || "A"}</span>
          </div>
          <div className="flex-1">
            <p className="text-sm font-medium text-white">{loginUser?.username}</p>
